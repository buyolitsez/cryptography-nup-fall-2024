...
\begin{proof}
	...
	Hence, the probability of success of $A_l$ is at least:
	\begin{align*}
		 \underbrace{\Pr[m_0 \text{ is sent }]}_{=\frac{1}{2}} \cdot \left(p_{f_0}(m_0) + (1 - p_{f_0}(m_0)) \cdot \frac{1}{2}\right) + \underbrace{\Pr[m_1 \text{ is sent }]}_{=\frac{1}{2}} \cdot \left((1 - q_{f_0}(m_1)) \frac{1}{2}\right) = \\
		 = \frac{1}{2} \left(1 + \frac{p_{f_0}(m_0) - q_{f_0}(m_1)}{2}\right).
	\end{align*}
	Hence, it is substantial and $A_l$ distinguish between  $m_0$ and  $m_1$.
\end{proof}
